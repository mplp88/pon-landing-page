<template>
  <div
    class="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 text-white"
  >
    <!-- Navigation -->
    <nav
      class="fixed top-0 w-full z-50 bg-slate-900/80 backdrop-blur-md border-b border-blue-500/20"
    >
    ...
    >
      <div class="max-w-4xl mx-auto px-6 text-center relative z-10">
        ...
        <!-- Tagline -->
        <p
          class="text-lg md:text-2xl text-slate-300 mb-6 md:mb-8 leading-relaxed"
        >
          {{ tagline }}
        </p>
        ...
        <p class="text-sm text-slate-400 mt-4">
          Entrega en 72 hs • Sin complicaciones
        </p>
      </div>
    </section>
    ...
    <section id="services" class="min-h-screen py-20 relative">
      <div class="max-w-6xl mx-auto px-6">
        <div class="text-center mb-16">
          <h2
            class="text-4xl md:text-5xl font-bold pb-4 bg-gradient-to-r from-blue-400 to-cyan-300 bg-clip-text text-transparent"
          >
            Servicios
          </h2>
          <p class="text-xl text-slate-400">
            Soluciones simples y efectivas para que tu negocio tenga presencia
            online y genere más consultas
          </p>
        </div>
    ...
    <section id="projects" class="min-h-screen py-20 relative">
      <div class="max-w-6xl mx-auto px-6">
        <div class="text-center mb-16">
          ...
          <p class="text-xl text-slate-400">
            Estos son algunos de mis últimos trabajos
          </p>
        </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          >
            <div
              class="aspect-video bg-gradient-to-br from-blue-900 to-slate-800 rounded-lg mb-4 flex items-center justify-center overflow-hidden"
            >
              <img
                :src="project.image"
                :alt="project.title"
        ...
        <div class="grid md:grid-cols-2 gap-12">
          ...
          <form @submit.prevent="submitForm" class="space-y-6">
            ...
            <button
              ...
              class="w-full px-8 py-4 bg-gradient-to-r from-blue-600 to-cyan-600 rounded-lg font-semibold hover:from-blue-700 hover:to-cyan-700 transition-all transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
            >
    ...
    <footer class="py-8 border-t border-slate-700">
      <div class="max-w-6xl mx-auto px-6 text-center">
        <p class="text-slate-400">© 2026 {{ brandName }}.</p>
      </div>
    </footer>
  </div>
  <ToastProvider />
...
const tagline = ref(
  'Mostrá tus productos online y recibí consultas por WhatsApp en minutos',
);
...
const projects = ref([
  {
    ...
    description:
      'Página web profesional para presentación y publicación de entradas de blog.',
...
const services = ref([
  ...
  },
  {
    ...
    description:
      'Vendé tus productos con carrito de compras y medios de pago integrados.',
    price: 'Desde $300.000',
    type: 'ecommerce',
    cta: {
      label: 'Consultar',
  ...
  },
  {
    ...
    description:
      'Sistemas personalizados, automatización e integraciones según tu negocio.',
    price: 'A medida',
    type: 'custom',
    cta: {
